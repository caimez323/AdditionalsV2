...
__eidItemDescriptions[SuperDamageId] = "+0.5 damage, +0.1 speed and +0.25 shot-Speed up#+Half soulheart#Deal bonus damages against bosses (even more if champions)"
...
__eidItemDescriptions[CursedGrailId] = "Add a 1.5* damage multiplier, +1 damage, +2 fire rate and 0.25 shotspeed#When your tears hit an enemy or a wall, has a chance to create a red that will hit enemies"
